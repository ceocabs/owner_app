...
class AssignVehicleViewModel {
  Future<List<dynamic>> assignVehicle(
      {required AssignVehicleRequestModel request,
    ...
    try {
      await client
          .request(ServiceApi.assignVehicle,
          data: mapReq, isAuthenticated: false)
          .then(
            (response) {
              AssignVehicleResponseModel obj =
              AssignVehicleResponseModel.fromJson(response.data);
