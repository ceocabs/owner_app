...
class ResendOtpViewModel {
  Future<List<dynamic>> resendOtp(
    ...
    try {
      await client
          .request(ServiceApi.resendOtp, data: mapReq, isAuthenticated: false)
          .then(
            (response) {
          ResendOtpResponseModel obj = ResendOtpResponseModel.fromJson(response.data);
